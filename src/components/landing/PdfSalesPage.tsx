...
import { PurchaseOffer } from "@/components/landing/PurchaseOffer";
      ...
      <main id="conteudo-principal">
        <section className="seller-hero" id="hero">
          ...
          <div className="seller-container seller-hero__bottom">
            <p><strong><AnimatedCount value={siteConfig.supplierCount} /></strong> registros <span aria-hidden="true">/</span> <strong><AnimatedCount value={8} /></strong> segmentos</p>
          ...
          <div className="seller-container seller-material__grid">
            <Reveal className="seller-heading">
              ...
              <div className="seller-material__facts">
                <span><strong><AnimatedCount value={siteConfig.contactCount} /></strong> contatos ou WhatsApp</span>
                <span><strong><AnimatedCount value={siteConfig.catalogCount} /></strong> links de catálogo</span>
              </div>
            </Reveal>
