...
export const supplierCategories = [
  {
    ...
    pcPages: "04 a 07",
    topics: ["Acessórios", "Brinquedos", "Higiene"],
  },
  {
    ...
    pcPages: "08 a 11",
    topics: ["Moda", "Cosméticos", "Cuidado pessoal"],
  },
  {
    ...
    pcPages: "12 a 18",
    topics: ["Casa", "Cozinha", "Organização"],
  },
  {
    label: "Ferramentas",
    count: 17,
    ...
    pcPages: "19 a 21",
    topics: ["Manuais", "Elétricas", "Acessórios"],
  },
  {
    label: "Eletrônicos",
    count: 42,
    ...
    pcPages: "22 a 28",
    topics: ["Informática", "Mobile", "Smartwatches"],
  },
  {
    label: "Brinquedos",
    count: 16,
    ...
    pcPages: "29 a 31",
    topics: ["Educativos", "Infantis", "Geek"],
  },
  {
    ...
    pcPages: "32",
    topics: ["Importados", "Presentes", "Variedades"],
  },
  {
    label: "Diversos",
    count: 2,
    ...
    pcPages: "33",
    topics: ["Fornecedores gerais", "Outros canais"],
  },
] as const;
